<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="GreenwichCommunityTheatre.Login" %>
        ...
        <div class="hero" >
            <div class="form-box">
                <div class="button-box">
                        ...
                        <div id="btn"></div>
                         <asp:Button OnClientClick="login()" ID="loginbtn" runat="server" Text="Login" CssClass="auto-style12"/>
                         <asp:Button OnClientClick="register()" ID="registerbtn" runat="server" Text="Register"  CssClass="auto-style12" OnClick="registerbtn_Click"   />
                ...
                <table align="center" style="text-align: center; vertical-align: top; padding-top: 4px; padding-bottom: 4px; table-layout: inherit; margin-right: 10px; margin-left: 10px;">
                    ...
                    <tr>
                        ...
                        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="login" Height="50px" Width="200px"/>
